...
class MonstersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create monster" do
    assert_difference('Monster.count') do
      post monsters_url, params: { monster: { agility: @monster.agility, element: @monster.element, exp: @monster.exp, force: @monster.force, hp: @monster.hp, name: @monster.name } }
    end
  ...
  test "should update monster" do
    patch monster_url(@monster), params: { monster: { agility: @monster.agility, element: @monster.element, exp: @monster.exp, force: @monster.force, hp: @monster.hp, name: @monster.name } }
