...
class AvatarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create avatar" do
    assert_difference('Avatar.count') do
      post avatars_url, params: { avatar: { element: @avatar.element, hp: @avatar.hp, name: @avatar.name } }
    end
  ...
  test "should update avatar" do
    patch avatar_url(@avatar), params: { avatar: { element: @avatar.element, hp: @avatar.hp, name: @avatar.name } }
